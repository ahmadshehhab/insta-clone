  ...
  return (
    ...
    <div className="navContainer">
      ...
      <div className="navPages">
          ...
          <Link className='NavLinks'  to='/a'><div className="navItemIcon"><img src={SearchIcon} /><li>Search</li></div></Link>
          <Link className='NavLinks' to='/search'><div className="navItemIcon"><img src={FindPeopleIcon} /><li>Explore</li></div></Link>
          <Link className='NavLinks' to='/search'><div className="navItemIcon"><img src={ReelsIcon} /><li>Reels</li></div></Link>
          <Link className='NavLinks' to='/search'><div className="navItemIcon"><img src={MessagesIcon} /><li>Messages</li></div></Link>
          ...
          <Link className='NavLinks' to='/search'><div className="navItemIcon"><img src={HomeIcon} /><li>Ahmad Shehab</li></div></Link>
          </div>
          <div className="navDown">
          <Link className='NavLinks' to='/search'><div className="navItemIcon"><img src={ResponsiveIcon} /><li>Search</li></div></Link>
